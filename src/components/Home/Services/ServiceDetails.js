...
const ServiceDetails = ({service}) => {
  ...
  const handleCourse = (courseName,img) =>{
    setLoggedInUser({courseName : courseName,img : img})
  }

    return ( 
     
        <div className="col-md-4 col-12 my-5">
           <Link to='/dashboard' className="text-decoration-none" onClick={() => handleCourse(service.title,service.image.img)}>
